          ...
          <div>
            ...
            <div className="space-y-2">
              {extraction.medications.map((m, i) => (
                <div key={i} className="grid grid-cols-[1fr_90px_110px_28px] items-center gap-2">
                  <input
                    value={m.name}
                    onChange={(e) => {
                    ...
                    className="rounded-lg border border-line-strong bg-paper-light px-3 py-2 text-sm text-ink outline-none focus:border-leaf"
                  />
                  <input
                    value={m.dosage}
                    onChange={(e) => {
