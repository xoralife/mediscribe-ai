          ...
          <div>
            ...
            <div className="space-y-3">
              {extraction.medications.map((m, i) => (
                <div key={i} className="rounded-xl border border-line bg-paper-light p-3">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-full min-w-0 flex-1 rounded-lg border border-line-strong bg-white px-3 py-2 text-sm text-ink outline-none focus:border-leaf"
                    />
                    <button
                      type="button"
                  ...
                  <div className="mt-2 grid grid-cols-2 gap-2 pl-6">
                    <input
                      ...
                      placeholder="Dosage"
                      className="w-full min-w-0 rounded-lg border border-line-strong bg-white px-3 py-2 text-sm text-ink outline-none focus:border-leaf"
                    />
                    <input
                      value={m.frequency}
                      onChange={(e) => {
